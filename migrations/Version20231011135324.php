 ...
 */
final class Version20231011135324 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish ADD category_id INT NOT NULL, DROP category');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE wish ADD category VARCHAR(80) DEFAULT NULL, DROP category_id');
    }
}
